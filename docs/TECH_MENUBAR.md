...
- 2026-09-21 已移除 `scripts/control_panel.html`、旧打开脚本及页面专属接口，control sidecar 只提供本地管理 API。正式用户入口只有菜单栏与副屏看板；排障读取 `/api/app/health` 和 `/api/status`。详见 [清理纪要](MAINTENANCE_2026-09-21.md)。
